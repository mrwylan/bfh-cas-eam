...
Prägend ist die Doppelrolle als *Produkthersteller* und als *Projektpartner*: Ausgeliefert wird ein Standardprodukt, das anschliessend pro Institut parametrisiert, erweitert und in eine bestehende Systemlandschaft eingebettet wird. Der Domänenzuschnitt folgt dem Kreditlebenszyklus --- Beratung und Initiierung, Kreditentscheid, Auszahlung, Portfolio- und Kontoverwaltung, Refinanzierung und Pfandbriefe ---, und an genau diesen Grenzen schliessen die Produkte des Portfolios einander an. Weil die Kundschaft aus Banken, Versicherungen und Pensionskassen besteht, wirken Aufsicht, interne Revision und Bankkundengeheimnis als nicht verhandelbare Randbedingungen direkt in die Architektur hinein.
