...
Es handelt sich dabei um ein fiktives Unternehmen, welcher technische wie operative und kommerzielle Aspekte jedes Ursprungsbetriebs vereint und Einzel hervorhebt. 
...
#design-entscheid([Für die Weiterentwicklung wichtige Entscheidungen, die in der Gruppe getroffen wurden, sind diesem Block entsprechend grafisch wiedergeben und festgehalten. ])

#stolperstein([Konzept- und Gedankenfehler, die wir während der Arbeit begangen haben, sind diesem Block entsprechend grafisch wiedergeben und festgehalten.])
#fuehrung([Mit diesem Block und dessen Grafik entsprechend wurden Passagen aus der Literatur übernommen.])
