...
Das Produkt als ganzes, inklusive aller fachlichen Aspekte wird, wenn nicht explizit als GastroStart benannt, auch als "System" bzeichnet.
...
Die Kantone brauchen eine Möglichkeit, Abweichungen in ihrem Regelwerk, die sich z. B. durch Gesetzesänderungen ergeben, im Sytem zu ändern.

== Registrierung
Die Registrierung erfordert, dass jeder Benutzer sich ein Profil im System erstellt, mit dem sie ihre Gründungsprozesse speichernm einsehen und verwalten können. 
...
Zudem soll den Benutzern der Status der einzelnen Schritte angezeigt (z.B. offen, bearbeitet, eingereicht, bewilligt), sowie ein Benachrichtigungssystem für die Kommunikation der Beteiligten untereinander, sowie von Statusuptates implementiert werden.

== Finanzierung
Die Finanzierung erfolgt in vielen Fällen kreditbasiert. 
Dazu wird den Benutzern ein Interface zur Auswahl ihrer bevorzugen Bank angezigt, sowie die Schnittstelle zur Bonitätsprüfung an FINNOFLEET implementiert.
