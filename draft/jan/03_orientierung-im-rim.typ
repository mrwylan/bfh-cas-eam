= Die Phase Orientierung im ressourcenunabhängigen Modell
...
Zu diesem Wunsch gehören viele Eigenschaften. 
Zum Beispiel die Art des Betriebes.
Handelt es sich um ein Cateringunternehmen?
Um ein Café oder um eine Bar, in der auch alkoholische Getränke serviert werden?
Die GründerInnen haban dabei vielleicht erstmal nur ihre Betriebszeiten und ihr Wunschcliente vor Augen.
Allerdings hat diese Entscheidung auch regulatorische Auswirkungen.
Und die wirken sich an verschiedenen Standorten gegebenenfalls anders aus.
...
Im ressourcenunabhängigen Modell nach Archi sind die Eigenschaften der Geschäftsobjekte zunächst nicht von Bedeutung.
...
- Personalien der BetribsinhaberInnen
...
Die Voraussetzung für Küchenbetrieb oder Alkoholausschank können sich kantonal unterscheiden.
Auch die Art und Austattung der Betriebsstätte kann kantonal bedingt unterschiedlich Einschränkend wirken.
In Wohngebieten zum Beispiel gelten oftmals strengere Auflagen für Lärm- und Geruchsvermeidung, als beispielsweise in Industriegebieten.
Die digitale Regelmatrix verknüpft die Eigenschaften des Gründungsvorhabens mit den jeweiligen kantonalen Anforderungen.
Im Rahmen der Geschäftstransaktion *Anforderungen ermitteln* wird mit Hilfe der Regelmatix und dem kantonalen Anforderungskatalog das Geschäftsobjekt *Bewilligungsübersicht* erstellt.
Dieses Objekt enthält alle, für das erfasste Gründungsvorhaben geltenden Auflagen und weitere, für eine erfolgreiche Bewilligung wichtigen Hinweise.
...
Die folgende Abblildung stellt die Zusammenhänge der Geschäftsobjekte, Zustände und Transaktionen im ressourcenunabhängigen Modell nach Archi dar.
Die hier beschrieben Variante liest sich als Happy Path - also die erfolgreiche Erstellung einer Bewilligungübersicht - auch wenn der hier verwendete Zielzutand *orientiert*, Raum für Variationen lässt.
