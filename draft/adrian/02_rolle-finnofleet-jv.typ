// Draft für: chapters/02_Mitglieder.typ  →  === FINNOFLEET (unter "Die Rollen der beteiligten Unternehmen im Joint-Venture")
// Ersetzt das #todo-action in 02_Mitglieder.typ:76
// Vorgabe: "kurz und knackig"
