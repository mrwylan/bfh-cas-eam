...
Erstens: die Werkzeuglücke im EA-Bereich ist nicht Ausdruck von Reife-Rückstand, sondern von struktureller Differenz. EA ist schwerer zu formalisieren als Software-Architektur, weil sie mehr Akteure, mehr Freiheitsgrade und mehr semantische Tiefe hat. Ein Werkzeug, das GFbUA bestmöglich unterstützt, muss diese Differenz respektieren und nicht wegabstrahieren wollen.
...
Was ich aus dem CAS in meine Praxis mitnehme, ist nicht in erster Linie ein Werkzeug oder eine Methode, sondern eine Haltung: dass Enterprise Architecture eine Disziplin ist, die sich an einem regulativen Ideal abarbeitet, das sie nie erreicht, an dem sie sich aber verantworten muss. Und dass die Werkzeuge, die wir für diese Arbeit nutzen, mitentscheidend sind, wie transparent, nachvollziehbar und stimmig diese Verantwortung geleistet werden kann.
